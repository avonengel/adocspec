...
`+dsn~oft-equivalent.description~1+`

The `SpecificationConverter` adds any paragraph that has no special meaning attached via prefix keywords to the
specification item's description.
